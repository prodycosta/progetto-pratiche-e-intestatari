            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="{{ route('pages.login') }}" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 mb-0">It looks like you found a glitch in the matrix...</p> <a href="{{ route('pages.index') }}">&larr; Back to Dashboard</a>
                    </div>
                </div>
